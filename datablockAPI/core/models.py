...
class CompanyInfo(Base):
    ...
    industry_codes = relationship("IndustryCode", back_populates="company_info", cascade="all, delete-orphan")
    trade_style_names = relationship("TradeStyleName", back_populates="company_info", cascade="all, delete-orphan")
    multilingual_names = relationship("MultilingualName", back_populates="company_info", cascade="all, delete-orphan")
    website_addresses = relationship("WebsiteAddress", back_populates="company_info", cascade="all, delete-orphan")
    telephone_numbers = relationship("TelephoneNumber", back_populates="company_info", cascade="all, delete-orphan")
    email_addresses = relationship("EmailAddress", back_populates="company_info", cascade="all, delete-orphan")
    registration_numbers = relationship("RegistrationNumber", back_populates="company_info", cascade="all, delete-orphan")
    stock_exchanges = relationship("StockExchange", back_populates="company_info", cascade="all, delete-orphan")
    banks = relationship("Bank", back_populates="company_info", cascade="all, delete-orphan")
    activities = relationship("CompanyActivity", back_populates="company_info", cascade="all, delete-orphan")
    employee_figures = relationship("EmployeeFigure", back_populates="company_info", cascade="all, delete-orphan")
    unspsc_codes = relationship("UNSPSCCode", back_populates="company_info", cascade="all, delete-orphan")
...
class EmployeeFigure(Base):
    ...
    information_scope_description = Column(String(200))  # Individual, Consolidated, etc.
    information_scope_dnb_code = Column(Integer)
